...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/neat")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/neat/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/neat/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/neat.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/neat.git")
            }
        }
    }
}